...
MAIN_SERVER=""
COUNTRY="${COUNTRY:-}"
BINARY_URL="https://raw.githubusercontent.com/CherniyPes228/partner-node-installer/main/downloads/partner-node/node-agent-linux-amd64-v0.3.0"
...
export MODEM_FLASH_ENABLED MODEM_FLASH_SCRIPT_PATH FLASH_ASSETS_BASE_URL FLASH_ASSETS_FALLBACK_BASE_URL
